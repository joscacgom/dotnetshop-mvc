...
namespace dotnetshop.Migrations
{
    ...
    [Migration("20240320211405_orderModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnetshop.Models.Company", b =>
                {
            ...
            modelBuilder.Entity("dotnetshop.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("dotnetshop.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("dotnetshop.Models.ShoppingCart", b =>
                {
            ...
            modelBuilder.Entity("dotnetshop.Models.OrderDetails", b =>
                {
                    b.HasOne("dotnetshop.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("dotnetshop.Models.OrderHeader", b =>
                {
                    b.HasOne("dotnetshop.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("dotnetshop.Models.AppUser", b =>
                {
                    b.HasOne("dotnetshop.Models.Company", "Company")
                        .WithMany()
